...
gender_degree_data = pd.read_csv(r"E:\Projects\2017.1.20_generateReports\ReportsGenerator\docx\docxoutput\patrolseasonal\csv\test.csv")  
...
majors = ['cpu1','cpu2','cpu3','mem1','mem2','mem3']  

for rank, column in enumerate(majors):  
    # Plot each line separately with its own color, using the Tableau 20  
    # color set in order.  
    plt.plot(gender_degree_data.machine.values,  
